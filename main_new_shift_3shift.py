...
from model.MSPM_with_3Shift import MultiscaleMixer
...
@hydra.main(config_path='./config', config_name='MSPM_3Shift', version_base=None)
def main(cfg):
    metadata = {
        ...
        'Shift Size': cfg.model.shift_size,
        'Shift Left': cfg.model.shift_l,
        'Shift Right': cfg.model.shift_r,
    ...
    model = MultiscaleMixer(
        ...
        shift_l=cfg.model.shift_l,
        shift_r=cfg.model.shift_r,
