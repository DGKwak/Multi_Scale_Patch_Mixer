...
class ShiftBlock(nn.Module):
    def __init__(self,
        ...
        self.channel_mixer_c = nn.Sequential(
            nn.Linear(patch_dim, patch_dim),
            get_activation(self.act),
            nn.LayerNorm(patch_dim),
        )
